...
if($result){
			...
			echo $url = $apiRootPath . 'GetAllServiceCountByCustomerId.php?customerId='.$service->customerId;
			$options = array(
				'http' => array(
					'header' => "Content-type: application/x-www-form-urlencoded\r\n",
					'method' => 'GET',
			...
			echo $SRCountArray['SRCount'];
			if($SRCountArray['SRCount'] == 1){
				echo $url = $apiRootPath . 'GetDiscountMasterByName.php?discountName='.$service->discountName;
				$options = array(
					'http' => array(
						'header' => "Content-type: application/x-www-form-urlencoded\r\n",
						'method' => 'GET',
				...
				//GetDiscountMasterDetails - 1st SR 				
			
				$url = $apiRootPath.'InsertServiceDiscount.php';	
				$addressData = array("serviceId" => $service->serviceId);
				$options = array(
				    'http' => array(
				        'header'  => "Content-type: application/x-www-form-urlencoded\r\n",
				        'method'  => 'POST',
