...
$vendor->APKVersion = $data->APKVersion;
$vendor->DeviceVersion = $data->DeviceVersion;
$vendor->DeviceType = $data->DeviceType;
$vendor->IMEI = $data->IMEI;
$vendor->createdOn = htmlspecialchars(strip_tags(date('Y/m/d H:i:s', time())));

 $result = $vendor->InsertVendorDetails();
