...
$vendorAvailability->vendorAvailabilityId    = $data->vendorAvailabilityId;
...
$vendorAvailability->modifiedOn = htmlspecialchars(strip_tags(date('Y/m/d H:i:s', time())));
$vendorAvailability->startDate = $data->startDate;
$vendorAvailability->endDate = $data->endDate;
$result = $vendorAvailability->UpdateVendorAvailability();
