...
class NotificationHistory{
    ...
    public function GetNotificationHistoryByCustomerId(){			
        try{
            ...
            $sql = "select * from Notification_History where NFH_CSR_GPK= :customerId order by NFH_createdOn desc"; //and PIN_status=1
    ...
    public function GetNotificationHistoryByVendorId(){			
        try{
            ...
            $sql = "select * from Notification_History where NFH_VDR_GPK= :vendorId order by NFH_createdOn desc"; //and PIN_status=1
            $result = $this->conn->prepare($sql);
    ...
    public function GetNotificationHistoryByLogisticsId(){			
        try{
            ...
            $sql = "select * from Notification_History where NFH_LGT_GPK= :logisticsId  order by NFH_createdOn desc"; //and PIN_status=1
            $result = $this->conn->prepare($sql);
